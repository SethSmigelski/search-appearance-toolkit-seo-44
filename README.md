...
* **Donate link:** [donate via paypal](https://www.paypal.com/donate/?hosted_button_id=M3B2Q94PGVVWL)
* **Plugin URI:**  [seo44plugin.com](https://www.sethcreates.com/plugins-for-wordpress/seo-44/)
* **Author URI:**  [sethcreates.com](https://www.sethcreates.com/plugins-for-wordpress/)
...
That's it. The plugin will now automatically add both the required GTM `<head>` script and `<body>` `<noscript>` tag to your entire site.
...
* **FIX:** Replaced dynamic string concatenation and added missing translators to meet internationalization (i18n) compliance standards 
